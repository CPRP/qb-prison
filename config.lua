...
Config.Uniforms ={
    ...
    ['female'] = {
        outfitData ={
			...
			['torso2'] = {item = 20, texture = 1},
			['arms'] = {item = 9, texture = 0},
			['pants'] = {item = 16, texture = 3},
			['shoes'] = {item = 64, texture = 1},
        }
    },
}
...
Config.Locations = {
    ...
    ["freedom"] = {
        coords = vector4(1830.45, 2595.99, 45.01, 137.75)
    },
    ["outside"] = {
        coords = vector4(1837.11, 2591.46, 46.01, 192.22)
    },
    ["yard"] = {
    ...
    ["shop"] = {
        coords = vector4(1779.89, 2560.81, 44.67, 185.2)
    },
    spawns = {
        [1] = {
            animation = "bumsleep",
